...
import { View, Text, FlatList, TextInput, TouchableOpacity, StyleSheet, SafeAreaView, Image, Alert,Button } from 'react-native';
...
const CourseLibrary = () => {
  ...
  const navigation = useNavigation<CourseLibraryNavigationProp>(); // Correct placement of useNavigation hook
    ...
    <SafeAreaView style={styles.container}>
      ...
      />
       <Button
        ...
        onPress={() => navigation.navigate('Analytics',{ courseTitle: "Mobile Development"})}
      />
    </SafeAreaView>
  );
};
